<%-- 
    Document   : editListadoA
    Created on : 22/10/2022, 03:05:01 PM
            ...
            <div class="card col-sm-8" id="hijo">
                <div  style="display: inline-block">
                    <ion-icon name="clipboard-outline" style="font-size: 64px;"></ion-icon>
                        <h1 style="text-align: center">Crear Listado de Actividades</h1>
                </div>
            </div>
        </div>
        <div class="d-flex" >
            <div class="card col-sm-8" id="hijo">
                <div class="card-body">
                    <form action="Controlador?menu=listado_a" method="POST">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input class="form-control" type="text" name="txtnombre" value="${nombreListado}"
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" readonly name="txtporcentaje" value="0" >
                        </div>
