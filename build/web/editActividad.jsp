<%-- 
    Document   : editActividad
    Created on : 22/10/2022, 05:21:04 PM
                ...
                <div class="card-body">
                    <form action="Controlador?menu=actividades" method="POST">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input class="form-control" type="text" name="txtnombre" value="${nombreActividad}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Estado</label>
                            <select name="txtfinalizada" default="${finalizada}">
                                <!--<option selected="true" disabled="disabled">$ {finalizada}</option>-->
